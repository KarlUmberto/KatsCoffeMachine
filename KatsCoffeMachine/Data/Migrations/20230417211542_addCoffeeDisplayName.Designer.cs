...
namespace KatsCoffeMachine.Data.Migrations
{
    ...
    [Migration("20230417211542_addCoffeeDisplayName")]
    partial class addCoffeeDisplayName
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KatsCoffeMachine.Models.Brand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KatsCoffeMachine.Models.Coffee", b =>
                {
                    b.HasOne("KatsCoffeMachine.Models.Brand", "Brand")
                        .WithMany("Coffees")
                        .HasForeignKey("BrandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KatsCoffeMachine.Models.CoffeeType", "CoffeeType")
                        .WithMany("Coffees")
