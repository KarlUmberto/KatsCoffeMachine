...
namespace KatsCoffeMachine.Controllers
{
    public class CoffeesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("Id,Brand,CoffeeType,CupsAvailable,CupsInPackage")] Coffee coffee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Brand,CoffeeType,CupsAvailable,CupsInPackage")] Coffee coffee)
        {
            if (id != coffee.Id)
            {
                return NotFound();
